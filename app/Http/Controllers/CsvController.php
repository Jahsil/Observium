...
class CsvController extends Controller
{
    ...
    public function parseObserviumCsv()
    {
        ...
        while ($line = fgetcsv($fh, 1000, ',')) {
            ...
            DB::table('test_observium_devices')->insert([
                ...
                'site' => $site,
                'device_name' => $device,
                'bandwidth' => (float)$formatted_Allocated_bw,
    ...
    public function parseDecSerial()
    {
        ...
        $filePath = './app/Http/obs/tracker_2.csv';
        ...
        $created_by = "59d51042-51ea-4d63-aafa-9d7c9a9ba5c8";
        $verified_by = "425ad9fa-6fdf-4768-b2c2-3a38a447b56f";
        ...
        while ($line = fgetcsv($fh, 1000, ',')) {
            ...
            list($serial_no, $stat, $location_id, $dec_serial, $prod_id) = $line;
            ...
            if ($declaration) {
                if ($device) {
                    ...
                    if($stat == "In store"){
                        // if item is in store 
                        try {
                            $added_device = DB::table('devices')->insertGetId([
                                'product_id' => $prod_id,
                            ...
                            echo "\n";
                            echo "Added : $serial_no :  ";
                            echo json_encode($added_device);
                            echo "\n";
                        ...
                        // item at a facility 
                        try {
                            $added_device_id = DB::table('devices')->insertGetId([
                                'product_id' => $prod_id,
                                'created_by' => $created_by,
                                "verified_by" => $verified_by,
                                "dec_id" => $declaration->id,
                            ...
                            echo "\n";
                            echo "Added to Facility : $serial_no :  ";
                            echo json_encode($added_device_id);
                            echo "\n";
                        } catch (\Exception $e) {
                            echo "Error: " . $e->getMessage();
                        }
